...
export const programs: Program[] = [
{
  ...
  slug: 'ai-literacy',
  summary:
  'Students learn to build with AI, evaluate its outputs critically, and design human-centered applications. Ethics, bias, and generative tools integrated throughout.',
  category: 'core',
  age_min: 14,
  age_max: 18,
  ...
  investment_note:
  'From KSh 10,000 per student per term. Pilot partnership rate available for first-time institutional partners.',
  is_published: true
},
{
  id: 2,
  ...
  summary:
  'Progressive coding pathways from Python fundamentals to full-stack development. Project-based, portfolio-driven, and aligned with real industry practices.',
  category: 'core',
  age_min: 15,
  age_max: 18,
...
},
{
  ...
  summary:
  'Hands-on engineering with Arduino, microcontrollers, sensors, and automation. Students build functioning robots and automated systems from first principles.',
  category: 'core',
  age_min: 15,
  age_max: 18,
  age_range: 'Ages 15–18',
  ...
  investment_note:
  'From KSh 12,000 per student per term. Pilot partnership rate available for first-time institutional partners.',
  is_published: true
},
{
  id: 4,
  ...
  summary:
  'Design thinking, venture creation, market validation, and real customer acquisition. Students launch micro-ventures with actual revenue—not hypothetical projects.',
  category: 'core',
  age_min: 16,
  age_max: 18,
