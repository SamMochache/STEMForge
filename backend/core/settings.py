...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",   # ← FIXED missing comma
...
# PostgreSQL Database (dotenv + Docker friendly)
DATABASES = {
    "default": {
...
# Add this at the bottom for development only
if DEBUG:
...
# Cache (required for token caching)
CACHES = {
    'default': {
